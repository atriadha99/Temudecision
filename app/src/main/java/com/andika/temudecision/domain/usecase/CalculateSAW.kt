...
import com.andika.temudecision.domain.methods.SAWMethod
import com.andika.temudecision.domain.model.*
import javax.inject.Inject

class CalculateSAW @Inject constructor() {
    private val method = SAWMethod()
    ...
    operator fun invoke(
        ...
        val dssAlternatives = alternatives.map { alt ->
            DSSAlternative(
                id = alt.id.hashCode().toLong(), // Simple mapping
                name = alt.name,
